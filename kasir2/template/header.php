...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
    <a class="navbar-brand" href="http://blogbangirfan.blogspot.com/"><i class="fa fa-shopping-cart mr-1"></i><b>
        <?php
  ...
  <div class="bg-purple text-center py-2 shadow-sm sticky-top d-none d-md-block">
    <a class="navbar-brand text-white" href="http://blogbangirfan.blogspot.com/"><i class="fa fa-shopping-cart mr-1"></i><b>
        <?php
        $toko = mysqli_query($conn, "SELECT * FROM toko ORDER BY nama_toko ASC");
        while ($dat = mysqli_fetch_array($toko)) {
          $nama_toko = $dat['nama_toko'];
      ...
      <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
          <div class="card-header bg-purple">
            <div class="card-tittle text-white">Hallo, <b><?= $_SESSION['user']; ?></b></div>
          </div>
          <div class="card-body">
            <ul class="navbar-nav">
              <li class="nav-item">
              ...
              ?>
              <li class="nav-item">
                <a class="nav-link" href="member.php"><i class="fa fa-user text-purple mr-2"></i>Member</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" onclick="confirmLogout(); return false;"><i class="fa fa-power-off text-purple mr-2"></i>Keluar</a>
              </li>
