...
if(isset($_POST['update']))
{
    ...
    $result = mysqli_query($conn, "UPDATE barang SET nama_barang='$nama',harga_barang='$harga',stok='$stok' WHERE id=$id");
    if(!$result){
      echo "
...
?>
        ...
        <div class="card-header bg-purple">
                <div class="card-tittle text-white"><i class="fa fa-shopping-cart"></i> <b>Update Barang</b></div>
            </div>
            <div class="card-body">
